...
//			"####" A 0 A_ZoomFactor(1.0);
			...
			"####" A 0 A_JumpIf(invoker.MO_CheckHaste(), "KickFaster");
			KCK1 ABC 1;
		...
		AirKick: //18 frames
			...
			"####" A 0 A_JumpIf(invoker.MO_CheckHaste(), "AirKickFaster");
			KCK2 ABC 1;
			"####" A 0 A_StartSound("playerkick",0);
			KCK2 DE 1;
	...
	bool JustPressedKick() // "which" being any BT_* value, mentioned above or not
    {
